...
let Tableau = [144, 202, 216, 222, 64];
/*
...
// let maVariable = Tableau[Tableau.length - 1];
...
// const Array = Tableau.map((element) => element / 2);

// console.log(Array);

// // 13) Pour vérifier si vous êtes correctement arrivé(e) jusqu'ici, essayez les deux lignes de code suivantes :
// console.log(Tableau.reduce((acc, cur) => acc + String.fromCharCode(cur), ""));
// console.log(
